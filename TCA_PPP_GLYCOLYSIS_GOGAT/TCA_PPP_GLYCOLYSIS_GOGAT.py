...
with open( cwd + '\\TCA_PPP_GLYCOLYSIS_GOGAT\\Python\\TCA_PPP_Glycolysis.dat', 'r') as f:
  print(f.read())
...
fdat = open(cwd+'\\TCA_PPP_GLYCOLYSIS_GOGAT\\Python\\TCA_PPP_Glycolysis.dat', 'r')
...
reaction_file = open('TCA_PPP_GLYCOLYSIS_GOGAT\\Python\\TCA_PPP_Glycolysis.keq', 'w')
