...
with open( cwd + '\\TCA_PPP_GLYCOLYSIS_GOGAT\\TCA_PPP_Glycolysis.dat', 'r') as f:
  print(f.read())
...
optimizer = torch.optim.SGD(nn_model.parameters(), lr=0.5*1e-6, momentum=0.9)
...
#%%
activity_method2 = np.loadtxt(cwd+'\\TCA_PPP_GLYCOLYSIS_GOGAT\\'+'activities_method2.txt', dtype=float)
epr_method2=4.141253187991768
...
plt.ylabel("<L>")
#%%
plt.plot(episodic_reward[150:200])
...
torch.save(nn_model, cwd+'\\TCA_PPP_GLYCOLYSIS_GOGAT\\'+'complete_model_gly_tca_gog_gamma9_n8_k5_lr5e6_1.pth')
#%% LOAD MODEL
#nn_model = torch.load(cwd+'\\TCA_PPP_GLYCOLYSIS_GOGAT\\'+'complete_model_gly_tca_gog_gamma9_n3_k15_2.pth')
#%%
np.savetxt(cwd+'\\TCA_PPP_GLYCOLYSIS_GOGAT\\'+'episodic_loss_gamma9_n8_k5_lr5e6_2.txt', episodic_loss, fmt='%f')
np.savetxt(cwd+'\\TCA_PPP_GLYCOLYSIS_GOGAT\\'+'episodic_loss_max_gamma9_n8_k5_lr5e6_2.txt', episodic_loss_max, fmt='%f')
np.savetxt(cwd+'\\TCA_PPP_GLYCOLYSIS_GOGAT\\'+'episodic_reward_gamma9_n8_k5_lr5e6_2.txt', episodic_reward, fmt='%f')

np.savetxt(cwd+'\\TCA_PPP_GLYCOLYSIS_GOGAT\\'+'final_states_gamma9_n8_k5_lr5e6_1.txt', final_states, fmt='%f')
np.savetxt(cwd+'\\TCA_PPP_GLYCOLYSIS_GOGAT\\'+'epr_per_state_gamma9_n8_k5_lr5e6_1.txt', epr_per_state, fmt='%f')

#%% Getting back the objects:
#episodic_loss_loaded = np.loadtxt(cwd+'\\TCA_PPP_GLYCOLYSIS_GOGAT\\'+'episodic_loss_gamma9_n8_k15_3.txt', dtype=float)
#episodic_loss_max_loaded = np.loadtxt(cwd+'\\TCA_PPP_GLYCOLYSIS_GOGAT\\'+'episodic_loss_max_gamma9_n8_k15_3.txt', dtype=float)
#episodic_reward = np.loadtxt(cwd+'\\TCA_PPP_GLYCOLYSIS_GOGAT\\'+'episodic_reward_gamma9_n8_k15_3.txt', dtype=float)

#final_states_loaded = np.loadtxt(cwd+'\\TCA_PPP_GLYCOLYSIS_GOGAT\\'+'final_states_gamma9_n8_k15_3.txt', dtype=float)
#epr_per_state_loaded = np.loadtxt(cwd+'\\TCA_PPP_GLYCOLYSIS_GOGAT\\'+'epr_per_state_gamma9_n8_k15_3.txt', dtype=float)
...
#np.savetxt(cwd+'\\TCA_PPP_GLYCOLYSIS_GOGAT\\'+'activities_ruleot_method2.txt', E_reg1, fmt='%f')
#np.savetxt(cwd+'\\TCA_PPP_GLYCOLYSIS_GOGAT\\'+'activities_experiment_method2.txt', E_reg1, fmt='%f')
...
#np.savetxt(cwd+'\\TCA_PPP_GLYCOLYSIS_GOGAT\\'+'activities_ruleot_NN.txt', E_reg1, fmt='%f')
#np.savetxt(cwd+'\\TCA_PPP_GLYCOLYSIS_GOGAT\\'+'activities_experiment_NN.txt', E_reg1, fmt='%f')
